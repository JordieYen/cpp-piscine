...
void	Bureaucrat::signForm(Form& form)
{
	...
	{
		std::cout << this->_name << " couldn't sign " << form.getName() << " because bureaucrat's grade is not high enough.\n";
	}
...
void	Bureaucrat::executeForm(Form& form)
{
	...
	{
		std::cout << this->_name << " couldn't execute " << form.getName() << " because bureaucrat's grade is not high enough.\n";
	}
	if (form.getStatus() == true)
	{
...
void	Bureaucrat::Bureaucrat::incrementGrade(void)
{
	try
	{
		this->_grade--;
