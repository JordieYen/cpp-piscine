...
{
	cout << "ClapTrap Default constuctor called\n";
	this->name = "NoNameClapTrap";
	this->setHp(10);
	this->setEp(10);
	this->setAd(0);
}
...
{
	cout << "ClapTrap String constuctor called\n";
	this->name = name;
	this->setHp(10);
	this->setEp(10);
	this->setAd(0);
...
{
	cout << "ClapTrap Copy constuctor called\n";
...
{
	cout << "ClapTrap Copy assignment operator called\n";
	this->name = clone.getName();
	this->setHp(clone.getHp());
	this->setEp(clone.getEp());
	this->setAd(clone.getAd());
